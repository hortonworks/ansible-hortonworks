...
| zone               | The Google Cloud Platform Zone as described [here](https://cloud.google.com/compute/docs/regions-zones/#available). |
...
| network            | The Google Cloud Platform network as described [here](https://cloud.google.com/vpc/docs/vpc). It will be created if it doesn't exist. |
